/****************************************************************************************************************************
  AsyncCaptivePortalAdvanced_ESP32_W5500.ino
...
/*
   ...
   Now the ESP32_W5500 is in your network. You can reach it through http://192.168.x.x/
...
#define _ASYNC_DNS_ESP32_W5500_LOGLEVEL_      1
...
void setup()
{
  ...
  Serial.println(ASYNC_DNS_SERVER_ESP32_W5500_VERSION);
